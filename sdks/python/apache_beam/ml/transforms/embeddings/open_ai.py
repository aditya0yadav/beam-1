...
class OpenAITextEmbeddings(EmbeddingsManager):
    ...
    # Override the expand method to properly define output types
    def expand(self, input_or_inputs):
        result = super().expand(input_or_inputs)
        # Cast the result to the correct type to satisfy type checker
        return cast(PCollection[Union[MLTransformOutputT, Row]], result)
